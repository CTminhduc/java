	...
	<div class="products-page">
		...
		<div class="new-product">
			<div class="new-product-top">
				...
				<p class="back">
					<a href="<c:url value='/trang-chu'/>">Back to Previous</a>
				</p>
			...
			<div class="mens-toolbar">
				<div class="sort">
					<div class="sort-by">
						...
						</select> <a href=""><img src="<c:url value='/template/user/images/arrow2.gif'/>" alt=""
							class="v-middle"></a>
					</div>
				</div>
			...
			<div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
				...
				<div class="clearfix"></div>
				<ul>
					<li><a class="cbp-vm-image" href="<c:url value='/product_details'/>">
							<div class="simpleCart_shelfItem">
								<div class="view view-first">
									<div class="inner_content clearfix">
										<div class="product_image">
											<img src="<c:url value='/template/user/images/p1.jpg'/>" class="img-responsive" alt="" />
											<div class="mask">
											...
											<div class="product_container">
												...
												<div class="pricey">
													<span class="item_price">$259.00</span>
												</div>
												<div class="clearfix"></div>
											</div>
										</div>
						...
						class="cbp-vm-icon cbp-vm-add item_add" href="#">Add to cart</a>
			</div>
			</li>
			<li><a class="cbp-vm-image" href="<c:url value='/product_details'/>">
					<div class="simpleCart_shelfItem">
							...
							<div class="inner_content clearfix">
								<div class="product_image">
									...
									<div class="product_container">
										...
										<div class="pricey">
											<span class="item_price">$189.00</span>
										</div>
										<div class="clearfix"></div>
									</div>
								</div>
		...
		<li><a class="cbp-vm-image" href="single.html">
				<div class="simpleCart_shelfItem">
					<div class="view view-first">
						<div class="inner_content clearfix">
							<div class="product_image">
			...
			<div class="cbp-vm-details">Kohlrabi bok choy broccoli rabe
				welsh onion spring onion tatsoi ricebean kombu chard.</div> <a
			class="cbp-vm-icon cbp-vm-add item_add" href="#">Add to cart</a>
	</div>
	</li>
	<li><a class="cbp-vm-image" href="single.html">
...
<li><a class="cbp-vm-image" href="single.html">
				...
				<div class="inner_content clearfix">
					<div class="product_image">
						...
						<div class="product_container">
							...
							<div class="pricey">
								<span class="item_price">$459.00</span>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
	...
	<div class="cbp-vm-details">Kohlrabi bok choy broccoli rabe welsh
		onion spring onion tatsoi ricebean kombu chard.</div> <a
	class="cbp-vm-icon cbp-vm-add item_add" href="#">Add to cart</a>
	</div></li>
<li><a class="cbp-vm-image" href="single.html">
		<div class="simpleCart_shelfItem">
				...
				<div class="inner_content clearfix">
					<div class="product_image">
						...
						<div class="product_container">
							...
							<div class="pricey">
								<span class="item_price">$169.12</span>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
...
<script src="<c:url value='/template/user/js/cbpViewModeSwitch.js'/>" type="text/javascript"></script>
<script src="<c:url value='/template/user/js/classie.js'/>" type="text/javascript"></script>
</div>
<div class="clearfix"></div>
</div>
<div class="clearfix"></div>
...
<div class="other-products">
	<div class="container">
		...
		<ul id="flexiselDemo3">
			<li><a href="single.html"><img src="images/l1.jpg"
				...
				<div class="product liked-product simpleCart_shelfItem">
					...
					<p>
						<a class="item_add" href="#"><i></i> <span class=" item_price">$759</span></a>
					</p>
				</div></li>
			<li><a href="single.html"><img src="images/l2.jpg"
				...
				<div class="product liked-product simpleCart_shelfItem">
					...
					<p>
						<a class="item_add" href="#"><i></i> <span class=" item_price">$699</span></a>
					</p>
				</div></li>
			...
			<li><a href="single.html"><img src="images/l4.jpg"
				...
				<div class="product liked-product simpleCart_shelfItem">
					...
					<p>
						<a class="item_add" href="#"><i></i> <span class=" item_price">$499</span></a>
					</p>
				</div></li>
			<li><a href="single.html"><img src="images/l5.jpg"
				...
				<div class="product liked-product simpleCart_shelfItem">
					<a class="like_name" href="single.html">Perfectly simple</a>
					<p>
						<a class="item_add" href="#"><i></i> <span class=" item_price">$649</span></a>
					</p>
				</div></li>
		</ul>
		...
		<script type="text/javascript" src="<c:url value='/template/user/js/jquery.flexisel.js'/>"></script>
	</div>
</div>
