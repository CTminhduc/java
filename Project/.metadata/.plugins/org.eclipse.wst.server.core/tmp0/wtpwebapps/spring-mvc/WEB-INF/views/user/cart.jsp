	...
	<div class="container">
		<div class="dreamcrub">
			<ul class="breadcrumbs">
				<li class="home"><a href="<c:url value='/trang-chu'/>" title="Go to Home Page">Home</a>&nbsp;
					<span>&gt;</span></li>
				<li class="women">Cart</li>
			</ul>
			<ul class="previous">
				<li><a href="<c:url value='/trang-chu'/>">Back to Previous Page</a></li>
			</ul>
			...
			<div class="cart-header">
				...
				<div class="cart-sec simpleCart_shelfItem">
					...
					<div class="cart-item-info">
						<h3>
							<a href="#"> Lorem Ipsum is not simply </a><span>Pickup
								time:</span>
						</h3>
						<ul class="qty">
