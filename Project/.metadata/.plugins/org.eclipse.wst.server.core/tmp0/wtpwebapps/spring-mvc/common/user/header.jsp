					...
					<a href="<c:url value='/cart'/>">
						<h3>
							<span class="simpleCart_total"> $0.00 </span> (<span
								id="simpleCart_quantity" class="simpleCart_quantity"> 0 </span>)<img
	...
	<div class="container">
		<nav class="navbar navbar-default" role="navigation">
			<div class="navbar-header">
				...
				<div class="logo">
					<h1>
						<a href="<c:url value='/trang-chu'/>"><span>E</span> -Shop</a>
					</h1>
				</div>
			</div>
			<!--/.navbar-header-->
							...
							<div class="row">
								<div class="col-sm-4">
									<ul class="multi-column-dropdown">
										<h6>NEW IN</h6>
										<li><a href="<c:url value='/products'/>">New In
												Clothing</a></li>
										<li><a href="<c:url value='/products'/>">New In Bags</a></li>
										<li><a href="<c:url value='/products'/>">New In Shoes</a></li>
										<li><a href="<c:url value='/products'/>">New In
												Watches</a></li>
										<li><a href="<c:url value='/products'/>">New In
												Grooming</a></li>
